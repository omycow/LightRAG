...
| 버전 | co@20 | co@10 | co@5 | 판정 (P1 ε=0 결정 런 기준) |
|---|---|---|---|---|
| v5.4~v5.12 | 69.6~72.2 | 51.5~54.9 | 35.8~42.7 | 동급 군집 (탐험 노이즈 내) |
| ~~v5.8 원기록~~ | ~~74.7~~ | ~~56.5~~ | ~~42.6~~ | 재현 실패 — ε 행운 런, 무효 |
| v5.13 (`structrag-v5.13`) | 69.8 | 52.2 | 41.1 | 위키화 가드·무롤백 |
| v5.14 (`structrag-v5.14`) | 86.5 | 79.1±0.49 | 72.6 | 에스코트 — 단, 핫패스 LLM 대기(수 초) 포함 |
| v5.15.1 (`structrag-v5.15.1`) | ~88 | 61.1→71.1 | — | 균일 레이턴시 아키텍처 확립 |
| **v5.20 (`structrag-v5.20`, 현행)** | 89.6 (피크 93.3) | 61.1→**74.4** (10-iter) | — | + 캐시 재최적화 — 장기 성장 실증, 10회 무롤백 |
